                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="px-2 py-1 bg-neon-purple/10 text-neon-purple transition-colors duration-300 rounded text-xs font-medium border border-neon-purple/30 font-modern group-hover:text-neon-lightpink group-hover:border-neon-lightpink"
                        >
                          {tech}
                        </span>
                      ))}
